...
public partial class EditKeyboardEventForm : Form
{
    ...
    public KeyboardAction KeyAction => (KeyboardAction)comboBoxAction.SelectedIndex;
    ...
    public EditKeyboardEventForm(KeyboardEvent keyboardEvent) : this(keyboardEvent.EventName)
    {
        ...
        textBoxEventName.Text = keyboardEvent.EventName ?? $"{keyboardEvent.TypeName}_{Rnd.GetString(4)}";
